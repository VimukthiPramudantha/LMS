...
const ManagePayment = () => {
    ...
    const handleSaveClick = async () => {
        ...
        try {
            const response = await axios.put(`https://primelms-server.netlify.app/api/payment/update/${editingPaymentId}`, editedPayment, {
                headers: {
        ...
        <div className="col-12 bg-light">
            <div className="row">
                ...
                <div className="col-12 col-lg-4 offset-0 offset-lg-8 d-flex gap-2 mt-4">
                    ...
                    <Link to="add-paymnet" type="button" className="btn btn-primary">
                        Create New Payment
                    </Link>
                </div>
