...
import DirectorHeadDashboard from "./DirectorHeadDashboard";
// import ManageStudent from "./ManageStudent";
// import AddStudentInstallment from "./AddStudentInstallment";

import ManageCampus from "./ManageCampus";
...
const DirectorHeadDashboardMain = () => {
  ...
  const iconMapping = {
    ...
    "Manage Campuses": "bi bi-clipboard-check",
    "Manage Courses": "bi bi-clipboard-check",
    ...
    "Manage Subjects": "bi bi-clipboard-check",
  ...
  return (
    <>
      ...
      >
        ...
        <Routes>
          <Route path="dashboard" element={<DirectorHeadDashboard />} />
          {/* Add other routes here */}
          <Route path="manage-campuses" element={<ManageCampus />} />
          <Route path="manage-campuses/add-campus" element={<AddCampus />} />
          <Route path="manage-courses" element={<ManageCourse />} />
          <Route path="manage-courses/add-course" element={<AddCourse />} />
          <Route path="manage-subjects" element={<ManageSubject />} />
          <Route path="manage-subjects/add-subject" element={<AddSubject />} />
          <Route path="manage-payments" element={<ManagePayment/>} />
          <Route path="manage-payments/add-payment" element={<AddPayment/>}/>
...
export default DirectorHeadDashboardMain;
