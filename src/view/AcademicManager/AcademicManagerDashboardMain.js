...
import AcademicManagerDashboard from "./AcademicManagerDashboard";
import ManageCourse from "./ManageCourse";
import AddCourse from "../commonPages/AddCourse";
import ManagePayment from "./ManagePayment";
import AddPayment from "../commonPages/AddPayment";

import ShowCoordinates from "./ShowCoordinate";
  ...
  return (
    <>
      ...
      >
        ...
        <Routes>
          <Route path="dashboard" element={<AcademicManagerDashboard />} />
          ...
          <Route path="show-Coordinators" element={<ShowCoordinates />} />
